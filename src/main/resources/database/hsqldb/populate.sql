...
INSERT INTO tasks (description, estimated_days, is_completed, created_by, last_update_date) VALUES
  ('learn Java', 20, TRUE, 'eric_cartman@gmail.com', '2017-06-07'),
  ('learn C', 15, FALSE, 'kenny_mckormick@gmail.com', '2017-06-17'),
  ('learn C++', 30, FALSE, 'kyle_broflovski@gmail.com', '2017-06-02'),
  ('learn C#', 25, FALSE, 'stanley_marsh@gmail.com', '2017-05-29'),
  ('learn Linux', 10, FALSE, 'sharon_marsh@gmail.com', '2017-06-20'),
  ('learn Sql/noSql', 27, TRUE, 'eric_cartman@gmail.com', '2017-05-28');
